...
watch(sortBy, (value) => {
  switch(value) {
    case 'newest': sortField.value='id'; sortOrder.value='desc'; break
    case 'oldest': sortField.value='id'; sortOrder.value='asc'; break
    case 'manufacturer-asc': sortField.value='manufacturer'; sortOrder.value='asc'; break
    case 'manufacturer-desc': sortField.value='manufacturer'; sortOrder.value='desc'; break
  }
  fetchVehicles()
})
...
function openDeleteModal(vehicle) {
  ...
  openModal(`Are you sure you want to delete ${vehicle.manufacturer} - ${vehicle.plate_number}?`, 'Confirm Deletion', true)
}

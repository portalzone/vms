  ...
  <div>
    ...
    <div class="grid grid-cols-1 gap-4 mb-4 md:grid-cols-2">
      <div class="flex flex-wrap items-center gap-2">
        ...
        <router-link
          to="/incomes/create"
          class="px-2 py-1 text-sm text-center border rounded btn-primary"
        >
          ➕ Add Income
        </router-link>
      </div>
      ...
      <div class="flex flex-wrap items-center gap-2">
        ...
        <select v-model="sortBy" class="px-2 py-1 text-sm border rounded">
      ...
      <div class="flex flex-wrap items-center gap-2">
        ...
        <select v-model="perPage" class="px-2 py-1 text-sm border rounded">
      ...
      <button
        ...
        :class="[
          'btn-pagination',
          {
            ...
            'pointer-events-none text-gray-400': p === '...',
          },
        ]"
        :disabled="p === '...'"
      >
...
const filteredIncomes = computed(() => {
  ...
  return incomes.value.filter(
    (i) => i.description?.toLowerCase().includes(term) || i.source?.toLowerCase().includes(term),
  )
})
